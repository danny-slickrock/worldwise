...
// Renders a country's map outline as a solid sand-coloured silhouette.
//
// Sand rather than navy: the outline always sits on a deep navy stage (the
// country-page hero, the Shape game's media box), so a navy silhouette would
// disappear into it. Warm land on deep water is also how a real map reads.
//
...
// paint the sand token *through* the outline by using the SVG as a CSS mask —
// browsers render SVG reliably, and alpha-masking recolors mapsicon's black
// silhouette to our brand sand. On native, <SvgUri> works and recolors via fill.
//
